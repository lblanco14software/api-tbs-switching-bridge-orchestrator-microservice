...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_COMMISSION_REPLACE_CARD_QUERY_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * CommissionReplaceCardQueryTransaction
 * <p>
 * CommissionQueryTransaction class.
 * Transaccion ConsultarComisionReposicionTarjeta
 * Transaccion CommissionReplaceCardQueryTransaction
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_COMMISSION_REPLACE_CARD_QUERY_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class CommissionReplaceCardQueryTransaction extends OrchestratorBaseTransaction {
    public CommissionReplaceCardQueryTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_COMMISSION_REPLACE_CARD_QUERY_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getCommissionQueryTransactionProducer();
    }
}
