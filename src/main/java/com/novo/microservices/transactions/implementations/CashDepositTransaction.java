...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_CASH_DEPOSIT_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * CashDepositTransaction
 * <p>
 * CashDepositTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_CASH_DEPOSIT_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class CashDepositTransaction extends OrchestratorBaseTransaction {

    public CashDepositTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_CASH_DEPOSIT_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getCashDepositTransactionProducer();
    }
}