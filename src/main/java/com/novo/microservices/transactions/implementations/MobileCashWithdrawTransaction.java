...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_MOBILE_CASH_WITHDRAW_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * WithdrawMobileMoneyTransaction
 * <p>
 * WithdrawMobileMoneyTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_MOBILE_CASH_WITHDRAW_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class MobileCashWithdrawTransaction extends OrchestratorBaseTransaction {
    public MobileCashWithdrawTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_MOBILE_CASH_WITHDRAW_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getMobileCashWithdrawTransactionProducer();
    }
}