...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_REPLACE_CARD_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * ReplaceCardTransaction
 * <p>
 * ReplaceCardTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_REPLACE_CARD_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class ReplaceCardTransaction extends OrchestratorBaseTransaction {
    public ReplaceCardTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_REPLACE_CARD_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getReplaceCardTransactionProducer();
    }
}