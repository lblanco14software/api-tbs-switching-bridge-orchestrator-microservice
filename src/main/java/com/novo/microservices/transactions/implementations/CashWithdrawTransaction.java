...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_CASH_WITHDRAW_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * WithdrawCashTransaction
 * <p>
 * WithdrawCashTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_CASH_WITHDRAW_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class CashWithdrawTransaction extends OrchestratorBaseTransaction {

    public CashWithdrawTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_CASH_WITHDRAW_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getCashWithdrawTransactionProducer();
    }
}