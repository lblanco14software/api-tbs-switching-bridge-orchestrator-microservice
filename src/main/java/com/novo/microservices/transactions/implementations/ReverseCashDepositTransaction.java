...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_REVERSE_CASH_DEPOSIT_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * ReverseCashDepositTransaction
 * <p>
 * ReverseDepositCashTransaction class.
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_REVERSE_CASH_DEPOSIT_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class ReverseCashDepositTransaction extends OrchestratorBaseTransaction {

    public ReverseCashDepositTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_REVERSE_CASH_DEPOSIT_TRANSACTION_CODE);
    }
    ...
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getReverseCashDepositTransactionProducer();
    }
}