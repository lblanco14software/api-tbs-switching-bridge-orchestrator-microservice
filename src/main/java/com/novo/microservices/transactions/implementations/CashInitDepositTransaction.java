...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_CASH_INIT_DEPOSIT_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * CashInitDepositTransaction
 * <p>
 * CashInitDepositTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_CASH_INIT_DEPOSIT_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class CashInitDepositTransaction extends OrchestratorBaseTransaction {

    public CashInitDepositTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_CASH_INIT_DEPOSIT_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getCashInitDepositTransactionProducer();
    }
}