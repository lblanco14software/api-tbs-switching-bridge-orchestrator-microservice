...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_REVERSE_INIT_DEPOSIT_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * ReverseInitDepositTransaction
 * <p>
 * ReverseInitDepositTransaction class.
 * Transaccion ReversoDepositoEfectivo
 * Transaccion ReverseDepositCashTransaction
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_REVERSE_INIT_DEPOSIT_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class ReverseInitDepositTransaction extends OrchestratorBaseTransaction {

    public ReverseInitDepositTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_REVERSE_INIT_DEPOSIT_TRANSACTION_CODE);
    }
    ...
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getReverseInitDepositTransactionProducer();
    }
}