...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_REVERSE_WITHDRAW_MOBILE_MONEY_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * ReverseWithdrawMobileMoneyTransaction
 * <p>
 * ReverseWithdrawMobileMoneyTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_REVERSE_WITHDRAW_MOBILE_MONEY_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class ReverseWithdrawMobileMoneyTransaction extends OrchestratorBaseTransaction {

    public ReverseWithdrawMobileMoneyTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_REVERSE_WITHDRAW_MOBILE_MONEY_TRANSACTION_CODE);
    }
    ...
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getReverseWithdrawMobileMoneyTransactionProducer();
    }
}