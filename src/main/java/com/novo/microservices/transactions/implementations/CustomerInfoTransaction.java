...
/**
 * CustomerInfoTransaction
 * <p>
 * CustomerInfoTransaction class.
 * Transaccion ConsultarDatosCliente
 * Transaccion CustomerInfoTransaction
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_CHECK_CUSTOMER_INFO_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class CustomerInfoTransaction extends OrchestratorBaseTransaction {
    public CustomerInfoTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_CHECK_CUSTOMER_INFO_TRANSACTION_CODE);
    }

    @Override
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getCustomerInformationTransactionProducer();
    }
}