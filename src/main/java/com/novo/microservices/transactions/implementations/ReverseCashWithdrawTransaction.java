...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_REVERSE_WITHDRAW_CASH_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * ReverseWithdrawCashTransaction
 * <p>
 * ReverseWithdrawCashTransaction class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_REVERSE_WITHDRAW_CASH_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class ReverseCashWithdrawTransaction extends OrchestratorBaseTransaction {

    public ReverseCashWithdrawTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_REVERSE_WITHDRAW_CASH_TRANSACTION_CODE);
    }
    ...
    public CommonBrokerConfiguration getBrokerConfigurationProducer() {
        return messageConfiguration.getReverseCashWithdrawTransactionProducer();
    }
}