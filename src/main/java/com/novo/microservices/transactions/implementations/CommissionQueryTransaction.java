...
import static com.novo.microservices.transactions.constants.OrchestratorTransactionConstants.ORCHESTRATOR_COMMISSION_QUERY_TRANSACTION_CODE;
import static org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE;

/**
 * CommissionQueryTransaction
 * <p>
 * CommissionQueryTransaction class.
 * Transaccion ConsultarComisionDeposito
 * Transaccion CommissionQueryTransaction
 * <p>
 * <p>
 ...
 */
@Log4j2
@Component(ORCHESTRATOR_COMMISSION_QUERY_TRANSACTION_CODE)
@Scope(SCOPE_PROTOTYPE)
public class CommissionQueryTransaction extends OrchestratorBaseTransaction {

    public CommissionQueryTransaction(final IStandardTransactionCommonMapper standardTransactionCommonMapper,
        ...
        super(standardTransactionCommonMapper,
            ...
            ORCHESTRATOR_COMMISSION_QUERY_TRANSACTION_CODE);
    }
