...
/**
 * IConciliationReportController
 * <p>
 * IConciliationReportController interface.
 * <p>
 * <p>
 ...
 * @since 23/5/22
 */
public interface IConciliationReportController {
    @Operation(summary = "Generate conciliation report", description = "Generate a zip file with the conciliation report encoded in base64")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    Mono<ResponseEntity<Object>> generateReport(@PathVariable @DateTimeFormat(pattern = "yyyyMMdd") @Past Date date);
}