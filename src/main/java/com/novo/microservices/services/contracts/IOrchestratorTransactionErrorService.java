 ...
 * @since 4/27/2022
 */
public interface IOrchestratorTransactionErrorService {

    Mono<OrchestrationSagaResponse> doOnProcessErrorInTransactionPublish(Event<TransactionMessage<StandardTransaction>> eventTransactionMessage);
}