...
/**
 * OrchestratorTransactionEventServiceTest
 * <p>
 * OrchestratorTransactionEventServiceTest class.
 * <p>
 * <p>
 ...
 */
@Log4j2
@SpringBootTest(classes = OrchestratorTransactionEventService.class)
...
class OrchestratorTransactionEventServiceTest {

    @Autowired
    private OrchestratorTransactionEventService service;
    ...
    @Test
    void doOnProcessTransactionResponseByEvent() {

        EventFixture event = EventFixture.builder().build();

        event.getInstance().getData().setCorrelationId("1");

        StepVerifier.create(service.doOnProcessTransactionResponseByEvent(event.getInstance()))
            .expectNext(OrchestrationSagaResponse.builder()
                ...
                .orchestratorTransactionInformation(OrchestratorTransactionInformation.builder()
                    ...
                    .messageTypeIndicator("0200")
                    .processingCode("380000")
                    .transactionEncrypted("EncryptedResponse")
                    .build())
