...
/**
 * OrchestratorTransactionStructureDataMappingServiceTest
 * <p>
 * OrchestratorTransactionStructureDataMappingServiceTest class.
 * <p>
 * <p>
...
class OrchestratorTransactionStructureDataMappingServiceTest {
    ...
    @InjectMocks
    private OrchestratorTransactionStructureDataMappingService service;

    @Mock
    private SagaTransactionalJsonHelper sagaTransactionalJsonHelper;

    private OrchestratorTransactionStructureDataMapping buildMapping(String serviceId,
                                                                     String messageTypeIndicator,
                                                                     String processingCode,
                                                                     String bankCode,
                                                                     String dataElement2) {
        var mapping = new OrchestratorTransactionStructureDataMapping();

        var fields = new ArrayList<StructureDataField>();
    ...
    private List<OrchestratorTransactionStructureDataMapping> buildMappings() {
    ...
    void findGlobalMapping() {
        ...
        when(sagaTransactionalJsonHelper.loadTransactionsStructureDataMappings()).thenReturn(mappings);
        ...
        assertFalse(mapping.get().getStructureDataFields().isEmpty());
        assertEquals(DATA_ELEMENT_2_GLOBAL, mapping.get().getStructureDataFields().get(0).getValue());
    }
    ...
    void findGlobalMappingByBankCode() {
        ...
        assertFalse(mapping.get().getStructureDataFields().isEmpty());
        assertEquals(DATA_ELEMENT_2_GLOBAL_BANK_CODE, mapping.get().getStructureDataFields().get(0).getValue());
    }
    ...
    void findTransactionMapping() {
        ...
        assertNull(mapping.get().getBankCode());
        assertFalse(mapping.get().getStructureDataFields().isEmpty());
        assertEquals(DATA_ELEMENT_2_TRANSACTION, mapping.get().getStructureDataFields().get(0).getValue());
    }
    ...
    void findTransactionMappingByBankCode() {
        ...
        assertEquals(BANK_CODE, mapping.get().getBankCode());
        assertFalse(mapping.get().getStructureDataFields().isEmpty());
        assertEquals(DATA_ELEMENT_2_TRANSACTION_BANK_CODE, mapping.get().getStructureDataFields().get(0).getValue());
    }
}