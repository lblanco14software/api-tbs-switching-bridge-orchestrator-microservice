...
class ReverseCashWithdrawTransactionTest {

    @Autowired
    ReverseCashWithdrawTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getReverseCashWithdrawTransactionProducer();
