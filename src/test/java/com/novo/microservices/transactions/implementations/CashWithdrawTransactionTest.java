...
class CashWithdrawTransactionTest {

    @Autowired
    CashWithdrawTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getCashWithdrawTransactionProducer();
