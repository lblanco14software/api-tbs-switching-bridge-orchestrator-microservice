...
class ReverseBalanceInquiryTransactionTest {

    @Autowired
    ReverseCheckBalanceTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getReverseCheckBalanceTransactionProducer();
