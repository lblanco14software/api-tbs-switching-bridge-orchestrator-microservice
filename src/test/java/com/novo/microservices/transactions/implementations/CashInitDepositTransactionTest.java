...
/**
 * CashInitDepositTransactionTest
 * <p>
 * CashInitDepositTransactionTest class.
 * <p>
 * <p>
...
class CashInitDepositTransactionTest {
    ...
    void buildStandardTransactionTest() {
        ...
        // When
        final StandardTransaction standardTransaction = cashInitDepositTransaction.buildStandardTransaction(orchestrationTransactionRequest);
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getCashInitDepositTransactionProducer();

        // When
        CommonBrokerConfiguration commonBrokerConfiguration = cashInitDepositTransaction.getBrokerConfigurationProducer();
