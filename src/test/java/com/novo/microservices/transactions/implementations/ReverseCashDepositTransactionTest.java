...
/**
 * ReverseCashDepositTransactionTest
 * <p>
 * ReverseCashDepositTransactionTest class.
 * <p>
 * <p>
...
class ReverseCashDepositTransactionTest {
    @Autowired
    ReverseCashDepositTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getReverseCashDepositTransactionProducer();
