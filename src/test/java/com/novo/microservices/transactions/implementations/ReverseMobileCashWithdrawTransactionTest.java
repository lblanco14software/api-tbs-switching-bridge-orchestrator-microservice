...
/**
 * ReverseWithdrawMobileMoneyTransactionTest
 * <p>
 * ReverseWithdrawMobileMoneyTransactionTest class.
 * <p>
 * <p>
...
class ReverseMobileCashWithdrawTransactionTest {

    @Autowired
    ReverseWithdrawMobileMoneyTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getReverseWithdrawMobileMoneyTransactionProducer();
