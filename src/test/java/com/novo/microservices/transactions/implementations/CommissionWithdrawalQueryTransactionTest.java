...
/**
 * CommissionWithdrawalQueryTransactionTest
 * <p>
 * CommissionWithdrawalQueryTransactionTest class.
 * <p>
 * <p>
...
class CommissionWithdrawalQueryTransactionTest {

    @Autowired
    CommissionWithdrawalQueryTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getCommissionQueryTransactionProducer();
