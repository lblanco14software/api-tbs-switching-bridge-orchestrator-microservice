...
/**
 * ChangePingTransactionTest
 * <p>
 * ChangePingTransactionTest class.
 * <p>
 * <p>
...
class ChangePingTransactionTest {

    @Autowired
    ChangePingTransaction transaction;
    @Autowired
    ...
    void buildStandardTransactionTest() {
        ...
        //Assertions.assertEquals("920000" ,standardTransaction.getDataElement_3());
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getChangePinTransactionProducer();
    ...
    @Test
    @Order(3)
    @DisplayName("Build Standard Transaction Response Test")
    void buildStandardTransactionResponseTest() {

        // Given
        final OrchestrationTransactionRequest orchestrationTransactionRequest = new OrchestrationTransactionRequestFixture().getInstance();
        final StandardTransactionResponseFixture standardTransactionResponseFixture = new StandardTransactionResponseFixture();
        final StandardTransaction standardTransactionExpected = new StandardTransactionRequestFixture().getInstance();
        standardTransactionExpected.setDataElement_3("960000");

        // When
        final OrchestrationTransactionResponse orchestrationTransactionResponse = transaction.buildSuccessfullyTransactionResponse(orchestrationTransactionRequest, standardTransactionExpected);

        // Then
        Assertions.assertNotNull(orchestrationTransactionResponse);
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe2(), standardTransactionExpected.getDataElement_2());
        //Assertions.assertEquals(standardTransaction.getDataElement_3(), standardTransactionExpected.getDataElement_3());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe4(), standardTransactionExpected.getDataElement_4());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe7(), standardTransactionExpected.getDataElement_7());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe11(), standardTransactionExpected.getDataElement_11());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe12(), standardTransactionExpected.getDataElement_12());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe13(), standardTransactionExpected.getDataElement_13());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe18(), standardTransactionExpected.getDataElement_18());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe22(), standardTransactionExpected.getDataElement_22());
        Assertions.assertEquals(orchestrationTransactionResponse.getTransaction().getDe4(), standardTransactionExpected.getDataElement_4());
    }
}