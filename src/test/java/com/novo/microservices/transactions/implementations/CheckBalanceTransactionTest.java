...
/**
 * CheckBalanceTransactionTest
 * <p>
 * CheckBalanceTransactionTest class.
 * <p>
 * <p>
...
class CheckBalanceTransactionTest {

    @Autowired
    CheckBalanceTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getCheckBalanceTransactionProducer();
