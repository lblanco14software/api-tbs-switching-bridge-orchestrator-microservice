...
/**
 * ReverseBalanceInquiryTransactionTest
 * <p>
 * ReverseBalanceInquiryTransactionTest class.
 * <p>
 * <p>
...
class ReverseCardReplacementTransactionTest {

    @Autowired
    ReverseCardReplacementTransaction transaction;
    @Autowired
    ...
    void factoryTest() {
        ...
        // Given
        final CommonBrokerConfiguration commonBrokerConfigurationExpected = messageConfiguration.getReverseCardReplacementTransactionProducer();
